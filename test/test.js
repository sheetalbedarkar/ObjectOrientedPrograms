...
//     {
//         var input = fs1.readFileSync("/home/bridgeit/ObjectOrientedProgram/InventoryManagement.json", JSON.stringify(input));
...
//     {
//         var input = fs1.readFileSync("/home/bridgeit/ObjectOrientedProgram/InventoryManagement.json");
...
//     {
//         var input = file1.readFileSync("/home/bridgeit/ObjectOrientedProgram/RegularExpression.txt");
...
//     it('Parse data must be javaScript object', function()
//     {
//         var input = file1.readFileSync("/home/bridgeit/ObjectOrientedProgram/Stock.json");
//         const text = JSON.parse(input)  //Parse the data, So data becomes a JavaScript object.
//         assert.isObject(text);
//     });
// });
...
//     it('Parse data must be javaScript object', function()
//     {
//         var input = file1.readFileSync("/home/bridgeit/ObjectOrientedProgram/InventoryManagerStock.json");
//         const text = JSON.parse(input)  //Parse the data, So data becomes a JavaScript object.
//         assert.isObject(text);
//     });
// });
...
//     it('Content of file should neither NULL nor UNDEFINED', function()
//     {
//         var input = file1.readFileSync("/home/bridgeit/ObjectOrientedProgram/AddressBook.json");
//         assert.exists(input);
//     });
// });
...
//     it('Parse data must be javaScript object', function()
//     {
//         var input = file1.readFileSync("/home/bridgeit/ObjectOrientedProgram/ClinicManagement.json");
//         const text = JSON.parse(input); //Parse the data, So data becomes a JavaScript object.
//         assert.isObject(text);
//     });
// });
