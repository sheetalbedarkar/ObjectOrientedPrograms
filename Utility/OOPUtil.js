...
class InventoryManagerStock 
{
            ...
            do 
            {
                ...
                if (this.checkString(name)) 
                {
                    ...
                    if (this.searchElement(data, name) == -1) 
                    {
                        ...
                        var data = file.writeFileSync('/home/bridgeit/ObjectOrientedProgram/InventoryManagerStock', JSON.stringify(data));
                    }
                    else 
                    {
                        flag = false;
    ...
    remove(data) 
    {
        try 
        {
            ...
            data = file.writeFileSync("/home/bridgeit/ObjectOrientedProgram/InventoryManagerStock.json", JSON.stringify(data));
        } 
        catch (e) 
        {
            console.log(e.message);
        ...
        do 
        {
            ...
            if (this.checkString(name)) 
            {
                ...
                stock[value2].shareprice = name3;
                 var data1 = file.writeFileSync('/home/bridgeit/ObjectOrientedProgram/InventoryManagement.json', JSON.stringify(data));
            } 
            else 
            {
                flag = false;
